...
public class ToAddDataSignOf implements Task {
    private FamilyDate dataFather;
    private co.com.tcs.training.test.web.academicportal.models.FamilyDate dataMother;

    public ToAddDataSignOf(FamilyDate dataFather, FamilyDate dataMother) {
    ...
    public static ToAddDataSignOf addData(FamilyDate dataFather,FamilyDate dataMother){
        return new ToAddDataSignOf(dataFather,dataMother);
    }
}
